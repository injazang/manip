...
def demo(model=None, gpu=None, training='train', load=None, num_labels=16, n_epochs=200, batch_size=32, use_mix='mix', datadir='',
    ...
    if model is 'misl':
        from models.MISLNet import MISLNet
        model = MISLNet(num_labels)
...
if __name__ == '__main__':
    #demo(model='misl', gpu=[0], training='train', n_epochs=200, batch_size=10, use_mix='mix', num_labels=20, coeff=False,
